...
urlpatterns = [
    ...
    path('lost-items/', lost_items_list, name='lost_items_list'),
    path('report-found/<int:lost_item_id>/', report_found_item, name='report_found'),
    
    path('mark-as-found/<int:item_id>/', mark_as_found, name='mark_as_found'),
    
    path('archive/<int:item_id>/', archive_lost_item, name='archive'),
