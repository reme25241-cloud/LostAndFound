...
def found_report_list(request):
    reports = FoundReport.objects.select_related('lost_item').order_by('-reported_at')
    return render(request, 'lost_found/found_report_list.html', {'reports': reports})
